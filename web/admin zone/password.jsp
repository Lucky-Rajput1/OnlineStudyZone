...
<section class="login-block">
	...
	<div class="row">
		<div class="col-md-4 login-sec">
		    <h2 class="text-center">Change Password</h2>
                    <form class="login-form" action="admin%20zone/login.jsp" method="post">
  ...
  <div class="copy-text">Created with <i class="fa fa-heart"></i> by <a href="http://grafreez.com">Lucky Raj</a></div>
		</div>
