...
public class registration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String command="insert into registration values('"+name+"','"+fname+"','"+checkGender+"','"+quli+"','"+mob+"','"+address+"','"+email+"','"+Encryptpass+"','"+email+fileName+"','"+city+"','"+d.toString()+"')";
         ...
         out.print("<script>alert('Thank Your Registration is successfull!');window.location.href='//login.jsp'</script>");
         }
         else{
         out.print("<script>alert('Sorry');window.location.href='/onilne.study/registration.jsp'</script>");
         }
        }
        else{
        out.print("<script>alert('Invailid ');window.location.href='/onilne.study/registration.jsp'</script>");
        }
        //processRequest(request, response);
    }
